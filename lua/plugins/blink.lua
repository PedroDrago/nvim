-- TODO:
-- Try to maximize cmp use like:
-- - [ ] Same mappings
-- - [ ] luasnip instead of friendly snippets
-- - [ ] snippet navigation
-- - [ ] custom icons (lspkind?) [make sure to check if default blink icons are good]
-- - [ ] custom cmp sources (AI, path, etc)
-- - [ ] same cmp window style (check if configuring multiple styles is easy, to solve the problem of different themes needing different highlights and borders in cmp windows)
